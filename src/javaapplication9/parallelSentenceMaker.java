...
public class parallelSentenceMaker {
...
//            "(", ")", "<", ">", "|", "/", "{", "}", ";", "`", "~", "%", "^", "=", "1", "2", "3", "4", "5", "6", "7", "8", "9", "0", "   ", "  ", "  "};
    ...
    public static void main(String[] args) throws Exception {
        ...
        String batch = "";
        amhWords = new String[34310];
        relatedEnglish = new String[34310][10];
        relatedEnglishRatio = new float[34310][10];
        amhWordRelatedTotal = new float[34310];
        String[] amharicBatch = new String[20000];
        String[] englishBatch = new String[20000];
        myWriter = new FileWriter("C:\\Users\\worki\\Desktop\\JWlinks\\English\\files\\oromiffaEngForEngNoDuplicaate2.txt", true);
        BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\worki\\Desktop\\JWlinks\\English\\files\\wordsRelationOroEng.txt"));
        BufferedReader br2 = new BufferedReader(new FileReader("C:\\Users\\worki\\Desktop\\JWlinks\\English\\files\\oromiffaForEngNoDuplicaate.txt"));
        BufferedReader br3 = new BufferedReader(new FileReader("C:\\Users\\worki\\Desktop\\JWlinks\\English\\files\\engForOromiffaNoDuplicaate.txt"));
