...
public class verbsMinimizer2 {
    ...
    static String[] suffixesOne = {"3ብ3ች0ው", "3ል3ች0ው", "3ብ3ችህ1", "3ል3ችህ1", "2ይ3ች0ው", "1ብ3ች0ው", "1ል3ች0ው", "1ብ3ችህ1", "1ል3ችህ1", "3ብ3ች1", "3ል3ች1", "3ብው6ት", "3ልው6ት", "1ብ3ች1", "1ል3ች1", "1ብው6ት", "1ልው6ት", "ል3ች0ው", "ብ3ች0ው", "ብ3ችህ1", "ል3ችህ1", "3ች0ው", "3ችህ1", "3ብ0ት", "3ል0ት", "3ብ3ት", "3ል3ት", "3ብው6", "3ብ6ት", "3ልው6", "3ል6ት", "3ው6ት", "2ይ3ት", "7ች0ው", "1ብ0ት", "1ል0ት", "1ብ3ት", "1ል3ት", "7ችህ1", "1ብው6", "1ብ6ት", "1ልው6", "1ል6ት", "1ው6ት", "ልው6ት", "ብ3ች1", "ብው6ት", "ል3ች1", "3ች1", "3ብህ", "3ብክ", "3ብሽ", "3ልህ", "3ልክ", "3ልሽ", "3ው6", "1ብኝ", "1ልኝ", "1ብን", "1ልን", "3ብኝ", "3ልኝ", "3ብን", "3ልን", "7ች1", "1ብህ", "1ብክ", "1ብሽ", "1ልህ", "1ልክ", "1ልሽ", "1ው6", "ብ0ት", "ል0ት", "ብ3ት", "ል3ት", "ብው6", "ብ6ት", "ልው6", "ል6ት", "ው6ት", "3ህ", "3ክ", "3ሽ", "3ው", "3ት", "3ኝ", "2ኝ", "3ን", "2ን", "2ው", "1ኝ", "1ን", "1ት", "7ት", "1ህ", "1ክ", "1ሽ", "0ው", "ብህ", "ብክ", "ብሽ", "ልህ", "ልክ", "ልሽ", "ው6", "0ኝ", "0ን", "ብኝ", "ልኝ", "ብን", "ልን", "3", "2", "1", "ህ", "ክ", "ው", "ኝ", "ን", "ሽ", ""};
    ...
    static String[] prefixesSixShort = {"እን", "ል", "ት", "ይ", ""};
    static int formerAdd = 0;
    static int add = 0;
    static PrintStream out = null;

    public static boolean validSuffix(String word) {
        for (int i = 0; i < suffixesOne.length; i++) {
            if (word.equals(suffixesOne[i])) {
                return true;
            }
        }
        return false;
    ...
    public static boolean validStart(String first, String second) {
        for (int i = 0; i < prefixesOne.length; i++) {
            
            if (first.startsWith(prefixesOne[i] + second)) {
                return true;
            }
        }
        return false;
    ...
    public static void main(String[] args) throws Exception {
        myWriter = new FileWriter("C:\\Users\\Misgana\\Desktop\\One\\classOnePrefixes.txt", true);
        myWriter2 = new FileWriter("C:\\Users\\Misgana\\Desktop\\One\\classOnePrefsuffixes.txt", true);
        ...
        String[] stems = new String[10128];
        String[] stemsGerund = new String[10128];
        String[] batch = new String[20000];
        String[] batchGerund = new String[20000];
        String[] batchRep = new String[20000];
        String[] batchSubObj = new String[20000];
        String[] tempSplit = null;
        String[] tempSplit2 = null;

        String[] tempPreffix = null;
        ...
        boolean irreg = false;
        try {
            br = new BufferedReader(new FileReader("C:\\Users\\Misgana\\Desktop\\One\\theOneProcessed.txt"));
            br2 = new BufferedReader(new FileReader("C:\\Users\\Misgana\\Desktop\\One\\theOneProcessedGerund.txt"));
            br5 = new BufferedReader(new FileReader("C:\\Users\\Misgana\\Desktop\\One\\classOneSubObj.txt"));
            br3 = new BufferedReader(new FileReader("C:\\Users\\Misgana\\Desktop\\One\\classOneStems.txt"));
            br4 = new BufferedReader(new FileReader("C:\\Users\\Misgana\\Desktop\\One\\classOneStemsGerund.txt"));
            while ((fileLine = br3.readLine()) != null && (fileLine2 = br4.readLine()) != null) {
                stems[counter] = fileLine;
                stemsGerund[counter] = fileLine2;
                counter++;
            }
            tempPreffix = new String[stems.length];
            tempSuffix = new String[stems.length];

            counter = -1;
            System.out.println("doneOne");
            while ((fileLine = br.readLine()) != null && (fileLine2 = br2.readLine()) != null
                    && (fileLine3 = br5.readLine()) != null) {
                if ( //                        (!(prev.equals("32_4") && fileLine3.equals("11_2")) && counter != -1)&& 
                        fileLine2.equals(prev2)) {
                    batch[counter] = batch[counter] + "\n" + fileLine;
                    batchSubObj[counter] = batchSubObj[counter] + "\n" + fileLine3;
                } else {
                    counter++;
                    batch[counter] = fileLine;
                    batchGerund[counter] = fileLine2;
                    batchRep[counter] = fileLine;
                    batchSubObj[counter] = fileLine3;
                }
                prev = fileLine3;
                prev2 = fileLine2;
            }
            System.out.println("doneTwo: " + counter + " : " + counter);
            boolean why = false;
            boolean doneDuplicate = false;
            for (int i = 0; i < batchGerund.length; i++) {
                if (batchGerund[i] == null) {
                    break;
                }
                for (int j = i - 1; j >= i - 10 && i - 10 >= 0; j--) {
                    if (batchGerund[i].equals(batchGerund[j])
                            && batch[i].equals(batch[j])
                            && i + add < stemsGerund.length
                            && stemsGerund[i + add].equals(batchGerund[i])) {
                        doneDuplicate = true;
                        break;
                    }
                }
                if (doneDuplicate) {
                    doneDuplicate = false;
//                    out.println("theDuplicate: "+batchGerund[i]);
//                    add++;
                    continue;
                }
                if (add != 0) {
                ...
                tempSplit = batch[i].split("\n");
                tempSplit2 = batchSubObj[i].split("\n");
                String tempStem = "";
                ...
                while (i + add < stemsGerund.length
                        && stemsGerund[i + add].equals(batchGerund[i])) {
                    why = true;
//                    out.println(stemsGerund[i + add]+" : "+batchGerund[i]+" : "+(i + add)+" : "+(i+formerAdd));
                    add++;
//                    out.println("Out: "+stemsGerund[i + add]+" : "+batchGerund[i]+" : "+(i + add)+" : "+(i+formerAdd));
                }

//                out.println("other: "+stemsGerund[i + add-1]+" : "+batchGerund[i]+" : "+(i + add)+" : "+(i+formerAdd)+" : "+i);
//                if (why) {
//                    add--;
//                }
//                if (!why) {
//                    
//                    out.println("error: " + stemsGerund[i + add-1] + " : " + (i + formerAdd) + " : " + (i + add-1) + " : " + batchGerund[i] + " : " + i);
//                } else {
//                    if(!stemsGerund[i + add-1].equals(batchGerund[i]))
//                    out.println("good: " + stemsGerund[i + add-1] + " : " + (i + formerAdd) + " : " + (i + add-1) + " : " + batchGerund[i] + " : " + i);
//                }
//                System.out.println((i + formerAdd)+" : "+(i + add));
//                out.println("whatHere: " + (i + formerAdd) + " : " + (i + add - 1));
                for (int j = 0; j < tempSplit.length; j++) {
                    done = false;
                    irreg = false;
//                    if (batchGerund[i].equals("መግደል"))

                    for (int k = i + formerAdd; k < i + add && k < stems.length; k++) {
//                        if (stemsGerund[k].equals("መግደል")) {
//                            out.println("check: " + tempSplit[j] + " : " + stems[k]+" : "+(i+formerAdd) + " : "+k+" : "+(i+add));
//                        }
                        String temp = "";
                        if (tempSplit[j].startsWith("ይይ")) {
                            tempSplit[j] = tempSplit[j].substring(1);
                            irreg = true;
                        }
                        if (validStart(tempSplit[j], stems[k])
                                //                                && validPrefix(tempSplit[j].substring(0, tempSplit[j].indexOf(stems[k])))
                                && (validSuffix(tempSplit[j].substring(tempSplit[j].indexOf(stems[k]) + stems[k].length()))
                                || tempSplit[j].startsWith("ስትስት"))) {

//                            if(tempSplit[j].equals("3ስል0ቅ0ክ")){
//                                out.println("theStem: "+stems[k]);
//                            }
//                            for (int n = 0; n < prefixesOne.length; n++) {
//                                if (tempSplit[j].startsWith(prefixesOne[n])) {
//                                    tempSplit[j] = tempSplit[j].substring(prefixesOne[n].length());
//                                    break;
//                                }
//                            }
                            if (tempSplit[j].startsWith("ስትስት")) {
                                if (tempSuffix[k] == null) {
                                    tempSuffix[k] =  "ስት-"
                                            + "ስት-" + tempSplit2[j];
                                } else {
//                               
                                    tempSuffix[k] = tempSuffix[k] + "__" +"ስት-"
                                            +  "ስት-" + tempSplit2[j];
                                }
                            } else if (irreg) {
                                if (tempSuffix[k] == null) {
                                    tempSuffix[k] = "ይ-"
                                            + tempSplit[j].substring(tempSplit[j].indexOf(stems[k]) + stems[k].length()) + "-" + tempSplit2[j];
                                } else {
//                               
                                    tempSuffix[k] = tempSuffix[k] + "__" + "ይ-"
                                            + tempSplit[j].substring(tempSplit[j].indexOf(stems[k])
                                                    + stems[k].length()) + "-" + tempSplit2[j];
                                }
                            } else {
                                if (tempSuffix[k] == null) {
                                    tempSuffix[k] = tempSplit[j].substring(0, tempSplit[j].indexOf(stems[k])) + "-"
                                            + tempSplit[j].substring(tempSplit[j].indexOf(stems[k]) + stems[k].length()) + "-" + tempSplit2[j];
                                } else {
//                               
                                    tempSuffix[k] = tempSuffix[k] + "__" + tempSplit[j].substring(0, tempSplit[j].indexOf(stems[k])) + "-"
                                            + tempSplit[j].substring(tempSplit[j].indexOf(stems[k])
                                                    + stems[k].length()) + "-" + tempSplit2[j];
                                }
                            }
//                            if (tempSuffix[k] == null) {
//                                tempSuffix[k] = tempSplit[j].substring(tempSplit[j].indexOf(stems[k]) + stems[k].length()) + "-" + tempSplit2[j];
//                            } else {
//                                tempSuffix[k] = tempSuffix[k] + "__" + tempSplit[j].substring(tempSplit[j].indexOf(stems[k]) + stems[k].length()) + "-" + tempSplit2[j];
//                            }
                            done = true;
                            break;

                        }
//                        tempStem = stems[k] + " | " + stems[i + formerAdd] + " : " + (i + formerAdd) + " : " + (k) + " : " + stemsGerund[k];
                    }
                    if (!done) {
//                        out.println(tempSplit[j] + " : " + tempStem + " : " + batchGerund[i]);
//                        out.println(tempSplit[j]);
                    }
                }
//                out.println("here: " + i + " : " + stems[i + formerAdd] + " : " + (i + formerAdd) + " : " + (i + add-1) + " : " + stemsGerund[i + add-1]);
//                if (why) {
...
//                }
        ...
        for (int i = 0; i < tempSuffix.length; i++) {
//            myWriter.write(tempPreffix[i]+"\n");
            myWriter2.write(tempSuffix[i] + "\n");
        }
        myWriter.close();
        myWriter2.close();
    }
