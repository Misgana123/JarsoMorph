 ...
 * @author worki
 */
public class calculateSentenceRelatednessOromiffa {
    ...
    public static void main(String[] args) throws Exception {
        ...
        BufferedReader br2 = new BufferedReader(new FileReader("C:\\Users\\worki\\Desktop\\JWlinks\\English\\files\\oromifaEnglishParallelBySentence.txt"));
...
//                    System.out.println("theError: "+splitted[i]);
        ...
        while ((fileLine = br2.readLine()) != null) {
            splitted = fileLine.split("\t");
            System.out.println(fileLine + " : " + processor(splitted[0], splitted[1]));
        }
    }
